...
In the beginning ESBs were based on Messaging-Oriented Middleware or required Java EE containers for runtime. They gained on popularity with the increased usage of web services, which were quickly integrated. ESB focuses on covering wide range of scenarios, supported with the tools out of box. It ties together multiple endpoints, where central broker do the heavy lifting of routing, transforming and managing.

On the other hand integration frameworks like Apache Camel or Spring Integration benefits mainly from outstandig support of enterprise integration patterns. They can be paired with message queues and other frameworks to enrich with missing features to be comparable with full ESBs.

 Previously mentioned can be viewed as traditional well know and verified approache. On the other hand wew emerging trend supported by innovative technological companies seems to be microservices. The idea behind microservices is fundamentally different from ESBs. There is no central point or smart mediator that routes communication, but they rather emphasize smart endpoints and fast transfer channel with minimum of features. Each microservice represents one logical or business feature of the system. The communication channels are not tied to process, but they use web services or remote calls.
...
The DZone's research provides interesting static on usage of technologies. 
The most popular technology among respondents is Spring Integration (42\%), closely followed by the Camel framework (38\%). In the category of ESBs, the winner is Mule ESB (16\%), then WebSphere ESB(15\%) and Oracle ESB (13\%). In conclusion lightweight integration frameworks are more popular taking 63\%.

 When ESBs and message queues are compared it ends slightly better for the ESBs. The most popular messaging is ActiveMQ (46\%) that beats low-latenty providers like ZeroMQ or IronMQ. 
 
 The conclusion based on the above mentioned numbers can be made that developers tends to choose lightweight modular solutions rather the full stack of unnecessary features.
...
\begin{thebibliography}{}
	\bibitem{camel-web} APACHE. \textit{Apache Camel} [online]. \copyright{} 2004- [cit. 2014-12-12]. Dostupné z: \url{http://camel.apache.org/}
	
		\bibitem{dzone} DZONE RESEARCH. \textit{Guide to Enterprise Integration} [online]. \copyright{} 2014- [cit. 2014-12-12]. Dostupné z: \url{http://www.dzone.com/research/guide-to-enterprise-integration}
	
	\bibitem{camel-in-action} IBSEN, Claus a Jonathan ANSTEY. \textit{Camel in Action}. Greenwich, Conn.: Manning, c2011, xxxi, ISBN 19-351-8236-6.
